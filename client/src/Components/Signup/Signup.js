					...
					<div className="login-form">
						...
						<div className="sign-up-htm">
							...
							<div className="group">
								...
								<select className="btnselect" onChange={(e) => setRole(e.target.value)}>
									<option id="pass" value="Searcher">
										Searcher
									</option>
									<option id="pass" value="Artist">
										Artist
									</option>
								</select>
							</div>
							<div className="group">
								<input
									...
									onClick={() =>
										dispatch(registerUser({ name, lastName, email, password, role }, history))
									}
								/>
							</div>
							<div className="hr" />
